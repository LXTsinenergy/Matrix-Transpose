...
int main()
{
    ...
    string continue_flag; // flag of continue or exit
    do {
        cout << "Enter rows count: ";
        getline(cin, rows_count_input);
        while (!validator.validate(rows_count_input)) {
            // validation of the entered rows count value
        ...
        getline(cin, columns_count_input);
